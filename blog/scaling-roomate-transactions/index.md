...
::: {.col-xl-6}
![](./before.png "Fig 1: Original Graph of Amounts Owed: Dan directly pays Bob")
:::

::: {.col-xl-6}
![](./after.png "Fig 2: Processed Result: Dan now indirectly pays Bob")
:::

:::

In my testing this algorithm could find the solution to an 800 node graph with ~300k edges in 21 minutes on a modern computer in 2025. However, that graph size isn't any where close to $n = 1,000,000$ and that eye watering $499999500000$ edges so how can we go faster?
